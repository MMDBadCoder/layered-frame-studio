...
`posterizer/tests.py` پوشش داده شده است (۳۹ آزمون).
...
### ۵.۳ تنظیمات فروشگاه
- حداقل/حداکثر عرض و ارتفاع
- قیمت هر سانتی‌متر مربع
- گرد کردن مبلغ
- جدول نمونهٔ قیمت با تنظیمات فعلی
...
از فایل `prompt`:
- خروجی مدل سه‌بعدی **STL** با ارتفاع متفاوت برای هر لایه
- تعیین ضخامت هر لایه برای مدل سه‌بعدی
